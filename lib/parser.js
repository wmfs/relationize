...
module.exports = function schemaFilesParser (schemaFiles) {
  ...
  function applyPropertyToColumn (column, property) {
    switch (property.type) {
      ...
      case 'integer':
        if (Object.prototype.hasOwnProperty.call(property, 'maxLength') && property.maxLength > 9) {
  ...
  function addRootTableFromSchemaFile (schemaName, tables, schemaFile) {
    ...
    if (!Object.prototype.hasOwnProperty.call(tables, tableName)) {
      ...
      if (!Object.prototype.hasOwnProperty.call(content, 'primaryKey')) {
        ...
        if (!Object.prototype.hasOwnProperty.call(content, 'required')) {
          content.required = ['id']
        } else {
      ...
      let property
      let column
      for (const propertyId in content.properties) {
        if (Object.prototype.hasOwnProperty.call(content.properties, propertyId)) {
              ...
              if (property.items.type === 'object') {
                ...
                targetPrimaryKey.forEach(
                  function (targetPrimaryKeyPropertyId) {
                    ...
                    if (!Object.prototype.hasOwnProperty.call(subDocFile.content.properties, fkPropertyId)) {
                ...
                if (!Object.prototype.hasOwnProperty.call(subDocFile.content, 'indexes')) {
                ...
                if (!Object.prototype.hasOwnProperty.call(subDocFile.content, 'fkConstraints')) {
          ...
          if (requiresColumn) {
            // Derive nullable
            if ((Object.prototype.hasOwnProperty.call(content, 'required') && content.required.indexOf(propertyId) !== -1) ||
              (Object.prototype.hasOwnProperty.call(content, 'primaryKey') && content.primaryKey.indexOf(propertyId) !== -1)) {
  ...
  schemaFiles.forEach(
    function (schemaFile) {
      ...
      if (!Object.prototype.hasOwnProperty.call(audit.schemas, schemaName)) {
